...
<div class="container mt-3">
    ...
    <div class="formCuaHang">
        <form action="/loai/add" method="post">
            <%--            id--%>
            <div class="mb-3 mt-3">
        ...
        <table class="table table-border">
            ...
            <c:forEach items="${listCH}" var="sv" varStatus="i">
                <tr>
                    ...
                    <td>${sv.ten}</td>
                    <td>
                        <a href="/loai/detail?id=${sv.id}" class="btn btn-primary " role="button"
                           aria-disabled="true">Detail</a>
                        <a href="/loai/view-update?id=${sv.id}" class="btn btn-success " role="button"
                           aria-disabled="true">Update</a>
                        <a href="/loai/remove?id=${sv.id}" class="btn btn-danger "
