        ...
        <table class="table table-border">
            ...
            <c:forEach items="${listCH}" var="sv" varStatus="i">
                <tr>
                    ...
                    <td>${sv.ten}</td>
                    <td>
                        <a href="/mau-sac/detail?id=${sv.id}" class="btn btn-primary " role="button"
                           aria-disabled="true">Detail</a>
                        <a href="/mau-sac/view-update?id=${sv.id}" class="btn btn-success " role="button"
                           aria-disabled="true">Update</a>
                        <a href="/mau-sac/remove?id=${sv.id}" class="btn btn-danger "
