        ...
        <form action="/nhan-vien/add" method="post">
            ...
            <div class="mb-3">
                <div class="col-6">
                    ...
                    <input type="radio" name="gioiTinhInput" ${ch.gioiTinh == "Nam"?"checked":""} value="Nam" checked/>Nam
                    <input type="radio" name="gioiTinhInput" ${ch.gioiTinh == "Nu"?"checked":""} value="Nu"/>Nu
                </div>
            </div>
            <%--    ngay sinh--%>
            <div class="mb-3">
