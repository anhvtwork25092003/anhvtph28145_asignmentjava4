        ...
        <table class="table table-border">
            ...
            <c:forEach items="${listCH}" var="sv" varStatus="i">
                <tr>
                    ...
                    <td>${sv.ten}</td>
                    <td>
                        <a href="/nha-san-xuat/detail?id=${sv.id}" class="btn btn-primary " role="button"
                           aria-disabled="true">Detail</a>
                        <a href="/nha-san-xuat/view-update?id=${sv.id}" class="btn btn-success " role="button"
                           aria-disabled="true">Update</a>
                        <a href="/nha-san-xuat/remove?id=${sv.id}" class="btn btn-danger "
